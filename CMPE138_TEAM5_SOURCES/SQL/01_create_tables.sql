...
-- Description: Creates all tables for the NBA Draft Scouting Database
-- Owner: Filho Tran
...
-- ============================================================
-- USER table (superclass for all roles)
-- Stores all platform users. Role column handles specialization.
-- ============================================================
CREATE TABLE [USER] (
...
-- ============================================================
-- COLLEGE
-- Stores college/university info for prospects
-- ============================================================
...
-- ============================================================
-- ARCHETYPE
-- Positional/skill classifications e.g. "3-and-D Wing"
-- ============================================================
...
-- ============================================================
-- PROSPECT
-- Core entity. College basketball players being evaluated.
-- ============================================================
...
-- ============================================================
-- PROSPECT_ARCHETYPE
-- Junction table for N:M between PROSPECT and ARCHETYPE
-- ============================================================
...
-- ============================================================
-- COLLEGE_STATS (weak entity, owner: PROSPECT)
-- Per-season college statistics for each prospect
-- ============================================================
...
-- ============================================================
-- SCOUTING_REPORT (weak entity, owner: PROSPECT)
-- Written evaluations submitted by scouts after watching games
-- ============================================================
...
-- ============================================================
-- BEHAVIORAL_ASSESSMENT (weak entity, owner: PROSPECT)
-- Behavioral flags tagged by scouts e.g. "High Motor", "Ball Stopper"
-- ============================================================
CREATE TABLE BEHAVIORAL_ASSESSMENT (
    assessment_id   INT,
    prospect_id     INT,
    flag_type       VARCHAR(10) CHECK (flag_type IN ('positive','negative','neutral')),
...
-- ============================================================
-- NBA_PLAYER_RECORD (weak entity, owner: PROSPECT)
-- Historical NBA career data used for prospect comparisons
-- ============================================================
CREATE TABLE NBA_PLAYER_RECORD (
    ...
    role_level      VARCHAR(20) CHECK (role_level IN ('bust','role player','starter','All-Star','superstar')),
    seasons_played  INT,
...
-- ============================================================
-- SHORTLIST_ENTRY (weak entity, owner: GM)
-- Prospects saved by a GM with internal notes
-- ============================================================
